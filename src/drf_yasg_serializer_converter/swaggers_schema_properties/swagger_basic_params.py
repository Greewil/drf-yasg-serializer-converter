...
# -- path params --
object_id_path_param = openapi.Parameter(
    'object_id',
    openapi.IN_PATH,
    description="ID of an object.",
    type=openapi.TYPE_INTEGER
)
object_uid_path_param = openapi.Parameter(
    'object_uid',
    openapi.IN_PATH,
...
limit_query_param = openapi.Parameter(
    'limit',
    openapi.IN_QUERY,
...
offset_query_param = openapi.Parameter(
    'offset',
    openapi.IN_QUERY,
...
sort_by_query_param = openapi.Parameter(
    'sort_by',
    openapi.IN_QUERY,
...
sort_desc_query_param = openapi.Parameter(
    'sort_desc',
    openapi.IN_QUERY,
...
search_text_query_param = openapi.Parameter(
    'search_text',
    openapi.IN_QUERY,
    description="Text search filter.",
    type=openapi.TYPE_STRING
)
date_to_query_param = openapi.Parameter(
    'date_to',
    openapi.IN_QUERY,
...
date_from_query_param = openapi.Parameter(
    'date_from',
    openapi.IN_QUERY,
...
date_query_param = openapi.Parameter(
    'date',
    openapi.IN_QUERY,
...
datetime_to_query_param = openapi.Parameter(
    'datetime_to',
    openapi.IN_QUERY,
...
datetime_from_query_param = openapi.Parameter(
    'datetime_from',
    openapi.IN_QUERY,
...
datetime_query_param = openapi.Parameter(
    'datetime',
    openapi.IN_QUERY,
...
object_id_query_param = openapi.Parameter(
    'object_id',
    openapi.IN_QUERY,
    description="ID search filter.",
    type=openapi.TYPE_INTEGER
)
object_uid_query_param = openapi.Parameter(
    'object_uid',
    openapi.IN_QUERY,
...
is_archived_query_param = openapi.Parameter(
    'is_archived',
    openapi.IN_QUERY,
